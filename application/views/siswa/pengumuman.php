  ...
  <div class="content">
    ...
    <?php if ($cek->status_pendaftaran == 'lulus') {?>
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          <h3>
            <center>
              Selamat <b><?php echo $nama; ?></b> <span class="label label-success" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Peserta Didik Baru <b>NAMA SEKOLAH</b>, Silahkan Cetak Surat Pengumuman Sebagai Bukti Lulus Seleksi.
              <hr>
    ...
    <?php }else{ ?>
      <div class="panel panel-info">
        ...
        <div class="panel-body">
          <h3>
            <center>~ Belum ada Pengumuman dari Panitia PPDB Online NAMA SEKOLAH ~</center>
          </h3>
        </div>
      </div>
    <?php } ?>
