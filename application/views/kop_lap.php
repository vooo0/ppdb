<table border="0" width="100%">
  <tr>
    ...
    <td align="center">
      ...
      <b style="font-size:30px;">NAMA SEKOLAH</b> <br>
  ...
  <tr>
    <td colspan="3" align="center" style="font-size:15px;">
      Sekretariat :  <img src="img/telp.jpg" alt="telp." style="margin-bottom:-5px;margin-right:-5px;">  <img src="img/kode_pos.jpg" alt="Kode Pos." style="margin-bottom:-3px;margin-right:-5px;"> 
      <br>
      Website :    e-mail : 
    </td>
  </tr>
